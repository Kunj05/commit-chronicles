...
import { GitCommit, Clock, File, User, Calendar, Search, ToggleLeft, ToggleRight } from 'lucide-react';
      ...
      <div className="glass-morphism rounded-xl p-6 space-y-4">
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <div className="space-y-2">
            <label className="text-sm text-muted-foreground">Filter by Author</label>
            <DropdownMenu>
