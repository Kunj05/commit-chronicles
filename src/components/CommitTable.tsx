...
import { GitCommit, Clock, File, User, Calendar,Download, Search, ToggleLeft, ToggleRight, BarChart, Table , Code2 } from 'lucide-react';
...
const CommitTable: React.FC<CommitTableProps> = ({ commits, loading, error,repoUrl }) => {
  ...
  const authors = [...new Set(commits.map((commit) => commit.commit.author.name))];
  const handleExportCsv = () => {
    const csv = [
      ['Commit', 'Date', 'Time', 'Files Changed', 'Author'].join(','),
                ...
                <div className="glass-morphism rounded-xl p-6 mb-9">
                  ...
                  <div className="flex justify-center items-center mt-4">
                    <div className="rounded-lg shadow-lg p-4 w-full max-w-6xl">
                      <div className="flex items-center gap-6"> {/* Flex container for a single row */}
                        ...
                        {/* Search Input */}
                        <div className="space-y-2 flex-1"> {/* Added flex-1 to make the input grow and take available space */}
